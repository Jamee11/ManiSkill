...
DATA_ROOT=${MANISKILL_EORT_DATA_ROOT:-/remote-home/jinminghao/datasets/maniskill_eort_push_cube_pilot}
RAW_ROOT="${DATA_ROOT}/raw"
OUTPUT_DIR="${DATA_ROOT}/derived"
NUM_TRAJ=${NUM_TRAJ:-10}
TRAJ_PATH="${RAW_ROOT}/PushCube-v1/motionplanning/push_cube_eort.h5"
